...
async function runAnalysisMode(agent, amount, riskLevel) {
    if (!amount) {
...
async function runExecutionMode(agent, amount, riskLevel) {
    if (!amount) {
...
async function runMonitoringMode(agent) {
...
async function runInteractiveMode(agent, amount, riskLevel, autoExecute) {
    console.log(`
  ╔══════════════════════════════════════════════════════════╗
  ║                🤖 INTERACTIVE MODE                       ║
  ║                                                          ║
...
function getMode(args) {
    if (args.includes('analyze') || args.includes('--analyze'))
        return 'analyze';
    if (args.includes('execute') || args.includes('--execute'))
        return 'execute';
    if (args.includes('monitor') || args.includes('--monitor'))
        return 'monitor';
    return 'interactive';
}
