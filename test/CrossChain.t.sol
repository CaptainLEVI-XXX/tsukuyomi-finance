...
//         vm.startPrank(alice);
//         MockERC20(USDC).approve(address(poolManager), 5_000e6);
//         MockERC20(USDT).approve(address(poolManager), 5_000e6);
...
//         vm.expectRevert(CrossChainStrategyManager.AllocationLimitExceeded.selector);
//         strategyManager.investCrossChain(1, aaveStrategyId, tokenIds, percentages, USDC);
